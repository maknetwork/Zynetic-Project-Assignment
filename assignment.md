...
5. Deliverables
6. Source Code: A GitHub repository link.
7. Environment: A docker-compose.yml to spin up the service and DB.
8. Documentation: A README.md explaining your architectural choices
